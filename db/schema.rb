...
ActiveRecord::Schema.define(version: 20150412163902) do
  ...
  add_index "comments", ["nanopost_id"], name: "index_comments_on_nanopost_id"
  ...
  add_index "nanoposts", ["user_id"], name: "index_nanoposts_on_user_id"
